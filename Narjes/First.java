...
public class First extends JFrame {
	...
	First() {
		...
		String intro = language == 0 ? "<html><div style=\"text-align: left;\">" + "<h3>BIENVENIDO A<</h3><h1>"
				...
				: language == 1 ? "<html><div style=\"text-align: left;\">" + "<h3>BEM-VINDO A<</h3><h1>" + "NARJES"
						+ " FREE SHOP</h1>"
						...
						: language == 2 ? "<html><div style=\"text-align: left;\">" + "<h3>WELCOME TO<</h3><h1>"
								...
								: "<html><div style=\"text-align: left;\">" + "<h3>BIENVENUE À<</h3><h1>" + "NARJES"
										+ " FREE SHOP</h1>"
		...
		about.addActionListener(e -> JOptionPane.showMessageDialog(null, idiomaString(language)[4], "NARJES", 1));
	...
	private String[] idiomaString(int idioma) {
		...
		String[] portugues = { "Mostrar", "Esconder", // pass hide show
				...
				,
				"ESTE APLICATIVO FOI PROJETADO PARA O FREE SHOP DE NARJES.\r\n"
